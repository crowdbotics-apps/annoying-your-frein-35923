...
## Project Structure
    ...
    ├── annoying_your_frein_35923  # Django project configurations
...
1. Clone this repo and `cd annoying_your_frein_35923`
...
2. Clone this repo and `cd annoying_your_frein_35923`
